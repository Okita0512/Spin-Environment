...
data2 = np.loadtxt("DEOM_alpha=0.01.dat", dtype = float)
plt.plot(data2[:,0], data2[:,1] - data2[:,7], "-", color = 'red', label = "DEOM")

data2 = np.loadtxt("TCL2_alpha=0.01.txt", dtype = float)
plt.plot(data2[:,0], data2[:,1] - data2[:,7], "--", color = 'blue', label = "TCL-2")


# data2 = np.loadtxt("5+5.dat", dtype = float)
# plt.plot(data2[:,0], data2[:,1] - data2[:,4], "k-", color = 'blue', label = "HEOM")
