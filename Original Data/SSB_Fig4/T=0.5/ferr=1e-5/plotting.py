...
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k-", color = 'green', label = "PFD = 5 + 5, dt = 0.001, ferr = 1e-5", linewidth = 1.5)

data2 = np.loadtxt("3+3_ferr=5e-7_tp=40.dat", dtype = float) # _M1_focused
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k-", color = 'blue', label = "PFD = 3 + 3, dt = 0.001, ferr = 5e-7, tp = 40", linewidth = 1.5)

# data2 = np.loadtxt("3+3_ferr=5e-7_tp=10.dat", dtype = float) # _M1_focused
# plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k-", color = 'red', label = "PFD = 3 + 3, dt = 0.001, ferr = 5e-7, tp = 10", linewidth = 1.5)

data2 = np.loadtxt("4+4_ferr=5e-7.dat", dtype = float) # _M1_focused
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k-", color = 'black', label = "PFD = 4 + 4, dt = 0.001, ferr = 5e-7, trial", linewidth = 1.5)
