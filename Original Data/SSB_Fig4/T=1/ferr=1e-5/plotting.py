...
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k-", color = 'black', label = "PFD = 4 + 4, dt = 0.001, ferr = 5e-7", linewidth = 1.5)

data2 = np.loadtxt("3+3.dat", dtype = float) # _M1_focused
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k-", color = 'blue', label = "PFD = 3 + 3, dt = 0.001, ferr = 1e-5", linewidth = 1.5)
