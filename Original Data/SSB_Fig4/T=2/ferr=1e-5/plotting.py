...
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k-", color = 'green', label = "PFD = 4 + 4, dt = 0.001, ferr = 1e-5", linewidth = 1.5)
...
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k-", color = 'yellow', label = "PFD = 5 + 5, dt = 0.001, ferr = 5e-7", linewidth = 1.5)
