...
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k-", color = 'red', label = "PFD = 4 + 4, dt = 0.001, ferr = 1e-5", linewidth = 1.5)

data2 = np.loadtxt("5+5.dat", dtype = float) # _M1_focused
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k--", color = 'red', label = "PFD = 5 + 5, dt = 0.001, ferr = 1e-5", linewidth = 1.5)

data2 = np.loadtxt("4+4_ferr=5e-7.dat", dtype = float) # _M1_focused
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k-", color = 'blue', label = "PFD = 4 + 4, dt = 0.001, ferr = 5e-7", linewidth = 1.5)

data2 = np.loadtxt("5+5_ferr=5e-7.dat", dtype = float) # _M1_focused
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k--", color = 'blue', label = "PFD = 5 + 5, dt = 0.001, ferr = 5e-7", linewidth = 1.5)

data2 = np.loadtxt("trial.txt", dtype = float) # _M1_focused
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k-", color = 'green', label = "trial", linewidth = 1.5)
