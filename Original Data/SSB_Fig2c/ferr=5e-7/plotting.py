...
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k-", color = 'red', label = "Prony = 6 + 5, ferr = 5e-7", linewidth = 1.5)

data2 = np.loadtxt("1e-5.dat", dtype = float) # _M1_focused
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k--", color = 'green', label = "Prony = 6 + 5, ferr = 1e-5", linewidth = 1.5)
...
ax.set_title('Spin Bath 5', font = 'Times New Roman', size = 18)
