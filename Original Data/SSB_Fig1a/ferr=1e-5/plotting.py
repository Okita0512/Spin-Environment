...
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k-", color = 'red', label = "Prony = 5 + 5", linewidth = 1.5)    #  * 0.97

# data2 = np.loadtxt("7+6_lmax_7.dat", dtype = float) # _M1_focused
# plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k-", color = 'green', label = "Prony = 7 + 6, lmax = 7", linewidth = 1.5)    #  * 0.97
