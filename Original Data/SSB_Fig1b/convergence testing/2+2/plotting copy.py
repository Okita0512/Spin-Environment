...
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "--", color = 'green', label = "PFD = 2 + 2", linewidth = 1.5)

data2 = np.loadtxt("3+3_ferr=5e-7_tp=10.dat", dtype = float) # _M1_focused
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "--", color = 'blue', label = "PFD = 3 + 3", linewidth = 1.5)
...
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "-", color = 'black', label = "PFD = 4 + 4", linewidth = 1.5)

data = np.loadtxt(Ref, dtype = float)
plt.plot(data[:,0], data[:,1], "k.", color = 'red', label = "ML-MCTDH")
