...
data2 = np.loadtxt("lmax=50_ferr=1e-5.dat", dtype = float) # _M1_focused
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "-", color = 'red', label = "4 + 4, lmax = 50, ferr = 5e-7", linewidth = 1.5)

data2 = np.loadtxt("lmax=100_ferr=5e-7.dat", dtype = float) # _M1_focused
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "--", color = 'red', label = "4 + 4, lmax = 100, ferr = 5e-7", linewidth = 1.5)

data2 = np.loadtxt("lmax=50_ferr=1e-8.dat", dtype = float) # _M1_focused
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "-", color = 'green', label = "4 + 4, lmax = 50, ferr = 1e-8", linewidth = 1.5)

data2 = np.loadtxt("lmax=50_nofilter.dat", dtype = float) # _M1_focused
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "-", color = 'blue', label = "3 + 3, lmax = 50, no filtering", linewidth = 1.5)
