...
data2 = np.loadtxt("5e-7.dat", dtype = float) # _M1_focused
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "-", color = 'blue', label = "dt = 0.001, ferr = 5e-7, lmax = 20", linewidth = 1.5)

data2 = np.loadtxt("1e-5.dat", dtype = float) # _M1_focused
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "--", color = 'green', label = "dt = 0.001, ferr = 1e-5, lmax = 20", linewidth = 1.5)

data2 = np.loadtxt("1e-5_lmax=100.dat", dtype = float) # _M1_focused
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "--", color = 'red', label = "dt = 0.001, ferr = 1e-5, lmax = 100", linewidth = 1.5)
