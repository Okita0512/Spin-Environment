...
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k-", color = 'green', label = "dt = 0.0002, ferr = 1e-3", linewidth = 1.5)

data2 = np.loadtxt("1e-4.dat", dtype = float) # _M1_focused
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k-", color = 'blue', label = "dt = 0.0002, ferr = 1e-4", linewidth = 1.5)

data2 = np.loadtxt("1e-5.dat", dtype = float) # _M1_focused
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k-", color = 'red', label = "dt = 0.0002, ferr = 1e-5", linewidth = 1.5)
