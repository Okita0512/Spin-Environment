...
data2 = np.loadtxt("lmax=20.dat", dtype = float) # _M1_focused
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k-", color = 'green', label = "dt = 0.001, ferr = 5e-7, lmax = 20", linewidth = 1.5)

data2 = np.loadtxt("ferr=1e-7_lmax=50.dat", dtype = float) # _M1_focused
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "k-", color = 'red', label = "dt = 0.001, ferr = 1e-7, lmax = 50", linewidth = 1.5)
