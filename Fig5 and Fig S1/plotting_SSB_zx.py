...
A, = plt.plot(data[:,0], data[:,1] - data[:,4], "-", linewidth = lw, color = color1, label = "DEOM")

data2 = np.loadtxt("SSB_a.txt", dtype = float)
...
data2 = np.loadtxt("SSB_b.txt", dtype = float)
B, = plt.plot(data2[:,0], data2[:,1] - data2[:,7], "--", linewidth = lw, color = color2, label = "TCL-2")
...
data2 = np.loadtxt("SSB_c.txt", dtype = float)
B, = plt.plot(data2[:,0], data2[:,1] - data2[:,7], "--", linewidth = lw, color = color2, label = "TCL-2")
