...
data = np.loadtxt("prop-rho-eq.dat-8-0.1-dt", dtype = float)
A, = plt.plot(data[:,0], data[:,1] - data[:,7], "-", linewidth = lw, color = color1, label = "DEOM")

data2 = np.loadtxt("TCL2-xy-xy-alpha=0.1.txt", dtype = float)
...
data = np.loadtxt("prop-rho-eq.dat-8-0.4-dt", dtype = float)
A, = plt.plot(data[:,0], data[:,1] - data[:,7], "-", linewidth = lw, color = color1, label = "DEOM")

data2 = np.loadtxt("TCL2-xy-xy-alpha=0.4.txt", dtype = float)
B, = plt.plot(data2[:,0], data2[:,1] - data2[:,7], "--", linewidth = lw, color = color2, label = "TCL-2")
