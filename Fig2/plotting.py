...
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "--", color = 'green', label = "$t$-PFD = 2 + 2,   CPU time: 3 min", linewidth = lw)

data2 = np.loadtxt("3+3_nofilter_lmax=45.dat", dtype = float)
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "--", color = 'blue', label = "$t$-PFD = 3 + 3,   CPU time: 180 min", linewidth = lw)

data2 = np.loadtxt("4+4_nofilter_lmax=45.dat", dtype = float)
plt.plot(data2[:,0], (data2[:,1] - data2[:,2]), "-", color = 'black', label = "$t$-PFD = 4 + 4,   CPU time: 6800 min", linewidth = lw)
